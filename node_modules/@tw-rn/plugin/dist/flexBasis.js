...
exports.default = (function (_a) {
    ...
    var flexBasis = theme("flexBasis") || {};
    var utilities = Object.entries(flexBasis).reduce(function (acc, _a) {
        var _b;
        var modifier = _a[0], value = _a[1];
        return __assign(__assign({}, acc), (_b = {}, _b[".basis-" + e(modifier)] = { "flex-basis": value }, _b));
    }, {});
